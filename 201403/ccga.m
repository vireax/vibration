...
% alpha(3) = 0.3; alpha(6) = 0.7; %   Rao case B
% alpha(10) = 0; %                    Rao Case C
% 
% alpha(9) = 0.3; %                   Kim 2D case B
% alpha(5)=0.4; alpha(13)= 0.3; %     Kim 2D case C
% 
% alpha(13) = 0.4; %                  Kim 3D case B
% alpha(1) = 0.3; alpha(21) = 50; %   Kim 3D case C
